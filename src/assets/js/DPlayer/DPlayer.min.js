! function (e, t) {
    ...
    return function (e) {
            ...
            S = function () {
                function e(t) {
                    ...
                    if (this.updateBar = function (e, t, n) {
                            ...
                            callback: function () {
                                n.container.getElementsByClassName("dplayer-danloading")[0].style.display = "none", n.options.autoplay && !o.isMobile ? n.play() : o.isMobile && n.pause()
                            },
                            error: function (e) {
                                n.notice(e)
                            },
                        ...
                        p.innerHTML = ".dplayer .dplayer-danmaku{font-size:18px}", document.head.appendChild(p)
                    }
                    this.video = this.container.getElementsByClassName("dplayer-video-current")[0], this.bezel = this.container.getElementsByClassName("dplayer-bezel-icon")[0], this.bezel.addEventListener("animationend", function () {
                        n.bezel.classList.remove("dplayer-bezel-transition")
                    }), this.playButton = this.container.getElementsByClassName("dplayer-play-icon")[0], this.paused = !0, this.playButton.addEventListener("click", function () {
                        n.toggle()
                    });
                    ...
                    var x = function () {
                            n.checkLoading = setInterval(function () {
                                k = n.video.currentTime, E || k !== b || n.video.paused || (n.container.classList.add("dplayer-loading"), E = !0), E && k > b && !n.video.paused && (n.container.classList.remove("dplayer-loading"), E = !1), b = k
                            }, 100)
                        },
                        C = function () {
                    ...
                    this.playedTime = !1, this.animationFrame = function () {
                        try {
                            n.playedTime && (n.updateBar("played", n.video.currentTime / n.video.duration, "width"), n.container.getElementsByClassName("dplayer-ptime")[0].innerHTML = l.default.secondToTime(n.video.currentTime)), window.requestAnimationFrame(n.animationFrame)
                        } catch (error) {
                    ...
                    var B = function (e) {
                            ...
                            t = t > 0 ? t : 0, t = t < 1 ? t : 1, n.updateBar("played", t, "width"), n.container.getElementsByClassName("dplayer-ptime")[0].innerHTML = l.default.secondToTime(t * n.video.duration)
                        },
                        S = function e(t) {
                    ...
                    var P = function (e) {
                        ...
                        H = function e() {
                            document.removeEventListener("mouseup", e), document.removeEventListener("mousemove", P), z.classList.remove("dplayer-volume-active")
                        };
                    N.addEventListener("click", function (e) {
                        ...
                        document.addEventListener("mousemove", P), document.addEventListener("mouseup", H), z.classList.add("dplayer-volume-active")
                    ...
                    var D = function () {
                        n.container.classList.remove("dplayer-hide-controller"), clearTimeout(n.hideTime), n.hideTime = setTimeout(function () {
                            n.video.played.length && !n.disableHideController && (n.container.classList.add("dplayer-hide-controller"), V(), te())
                        }, 2e3)
                    };
                    ...
                    var V = function () {
                            A.classList.contains("dplayer-setting-box-open") && (A.classList.remove("dplayer-setting-box-open"), R.classList.remove("dplayer-mask-show"), setTimeout(function () {
                                A.classList.remove("dplayer-setting-box-narrow"), A.innerHTML = I.original, Q()
                            }, 300)), n.disableHideController = !1
                        },
                        j = function () {
                            n.disableHideController = !0, A.classList.add("dplayer-setting-box-open"), R.classList.add("dplayer-mask-show")
                        };
                    ...
                    var X = this.user.get("unlimited"),
                        Q = function () {
                            ...
                            t.checked = n.loop, e.addEventListener("click", function () {
                                t.checked = !t.checked, t.checked ? n.loop = !0 : n.loop = !1, V()
                            });
                            ...
                            s.checked = W, a.addEventListener("click", function () {
                                s.checked = !s.checked, s.checked ? (W = !0, n.paused || n.danmaku.show()) : (W = !1, n.danmaku.hide()), n.user.set("danmaku", W ? 1 : 0), V()
                            });
                            ...
                            if (r.checked = X, o.addEventListener("click", function () {
                                    r.checked = !r.checked, r.checked ? (X = !0, n.danmaku.unlimit(!0)) : (X = !1, n.danmaku.unlimit(!1)), n.user.set("unlimited", X ? 1 : 0), V()
                                }), n.container.getElementsByClassName("dplayer-setting-speed")[0].addEventListener("click", function () {
                                    A.classList.add("dplayer-setting-box-narrow"), A.innerHTML = I.speed;
                                    for (var e = A.getElementsByClassName("dplayer-setting-speed-item"), t = 0; t < e.length; t++) ! function (t) {
                                        e[t].addEventListener("click", function () {
                                            n.video.playbackRate = e[t].dataset.speed, V()
                                        })
                                    }(t)
                                }), n.danmaku) {
                                ...
                                n.on("danmaku_opacity", function (e) {
                                    n.updateBar("danmaku", e, "width"), n.user.set("opacity", e)
                                }), n.danmaku.opacity(n.user.get("opacity"));
                                var p = function (e) {
                                        var t = e || window.event,
                                            i = (t.clientX - l.default.getElementViewLeft(c)) / 130;
                                        i = i > 0 ? i : 0, i = i < 1 ? i : 1, n.danmaku.opacity(i)
                                    },
                                    h = function e() {
                                        document.removeEventListener("mouseup", e), document.removeEventListener("mousemove", p), u.classList.remove("dplayer-setting-danmaku-active")
                                    };
                                d.addEventListener("click", function (e) {
                                    ...
                                    document.addEventListener("mousemove", p), document.addEventListener("mouseup", h), u.classList.add("dplayer-setting-danmaku-active")
                                })
                            }
                        };
                    Q(), 1 !== this.video.duration && (this.container.getElementsByClassName("dplayer-dtime")[0].innerHTML = this.video.duration ? l.default.secondToTime(this.video.duration) : "00:00"), this.danmaku || (this.options.autoplay && !o.isMobile ? this.play() : o.isMobile && this.pause());
                    var U = this.container.getElementsByClassName("dplayer-controller")[0],
                        ...
                        te = function () {
                            U.classList.contains("dplayer-controller-comment") && (U.classList.remove("dplayer-controller-comment"), R.classList.remove("dplayer-mask-show"), n.container.classList.remove("dplayer-show-controller"), Z(), n.disableHideController = !1)
                        },
                        ne = function () {
                            n.disableHideController = !0, U.classList.contains("dplayer-controller-comment") || (U.classList.add("dplayer-controller-comment"), R.classList.add("dplayer-mask-show"), n.container.classList.add("dplayer-show-controller"), Y.focus())
                        };
                    R.addEventListener("click", function () {
                        te()
                    ...
                    ie.addEventListener("click", function () {
                        if (ie.querySelector("input:checked+span")) {
                            ...
                            J.getElementsByClassName("dplayer-fill")[0].style.fill = e, Y.style.color = e, K.getElementsByClassName("dplayer-fill")[0].style.fill = e
                        }
                    });
                    var ae = function () {
                        if (Y.blur(), !Y.value.replace(/^\s+|\s+$/g, "")) return void n.notice(n.tran("Please input danmaku content!"));
                        n.danmaku.send({
                            text: Y.value,
                    ...
                    }), K.addEventListener("click", ae), this.fullScreen = new L.default(this), this.container.getElementsByClassName("dplayer-full-icon")[0].addEventListener("click", function () {
                    ...
                    if (this.container.addEventListener("contextmenu", function (e) {
                        ...
                        le.addEventListener("click", function () {
                            ...
                            var t = e.toDataURL();
                            le.href = t, le.download = "DPlayer.png", n.events.trigger("screenshot", t)
                        })
                    }
                    if (this.options.subtitle) {
                        ...
                        this.events.on("subtitle_show", function () {
                            re.dataset.balloon = n.tran("Hide subtitle"), de.style.opacity = "", n.user.set("subtitle", 1)
                        }), this.events.on("subtitle_hide", function () {
                            re.dataset.balloon = n.tran("Show subtitle"), de.style.opacity = "0.4", n.user.set("subtitle", 0)
                ...
                return s(e, [{
                    ...
                    key: "play",
                    value: function () {
                        if (this.paused = !1, this.video.paused && (this.bezel.innerHTML = this.icons.get("play"), this.bezel.classList.add("dplayer-bezel-transition")), this.playButton.innerHTML = this.icons.get("pause"), this.video.play(), this.setTime(), this.container.classList.add("dplayer-playing"), this.danmaku && this.danmaku.play(), this.options.mutex)
                    ...
                    value: function (e, t, n) {
                        if (e = parseFloat(e), !isNaN(e)) {
                            ...
                            this.container.getElementsByClassName("dplayer-volume-bar-wrap")[0].dataset.balloon = i, t || this.user.set("volume", e), n || this.notice(this.tran("Volume") + " " + (100 * e).toFixed(0) + "%"), this.video.volume = e, this.video.muted && (this.video.muted = !1), this.switchVolumeIcon()
                        }
                    ...
                    key: "switchVideo",
                    value: function (e, t) {
                        this.pause(), this.video.poster = e.pic ? e.pic : "", this.video.src = e.url, this.initMSE(this.video, e.type || "auto"), t && (this.container.getElementsByClassName("dplayer-danloading")[0].style.display = "block", this.updateBar("played", 0, "width"), this.updateBar("loaded", 0, "width"), this.container.getElementsByClassName("dplayer-ptime")[0].innerHTML = "00:00", this.container.getElementsByClassName("dplayer-danmaku")[0].innerHTML = "", this.danmaku && this.danmaku.reload({
                            id: t.id,
                            address: t.api,
                            token: t.token,
                            maximum: t.maximum,
                    ...
                    value: function (e, t) {
                        ...
                        this.volume(this.user.get("volume"), !0, !0), this.options.subtitle && (this.subtitle = new B.default(this.container.getElementsByClassName("dplayer-subtitle")[0], this.video, this.options.subtitle, this.events), this.user.get("subtitle") || this.subtitle.hide())
                    }
                }, {
                    key: "switchQuality",
                    value: function (e) {
                        ...
                        if (this.qualityIndex !== e && !this.switchingQuality) {
                            this.qualityIndex = e, this.switchingQuality = !0, this.quality = this.options.video.quality[e], this.container.getElementsByClassName("dplayer-quality-icon")[0].innerHTML = this.quality.name;
                            ...
                            s.insertBefore(a, s.getElementsByTagName("div")[0]), this.prevVideo = this.video, this.video = a, this.initVideo(this.video, this.quality.type || this.options.video.type), this.seek(this.prevVideo.currentTime), this.notice(this.tran("Switching to") + " " + this.quality.name + " " + this.tran("quality"), -1), this.events.trigger("quality_start", this.quality), this.on("canplay", function () {
                                if (t.prevVideo) {
                                    ...
                                    s.removeChild(t.prevVideo), t.video.classList.add("dplayer-video-current"), n || t.video.play(), t.prevVideo = null, t.notice(t.tran("Switched to") + " " + t.quality.name + " " + t.tran("quality")), t.switchingQuality = !1, t.events.trigger("quality_end")
                                }
                            })
                        }
                    }
                    ...
                    value: function () {
                        var e = this;
                        this.thumbnails = new b.default(this.container.getElementsByClassName("dplayer-bar-preview")[0], this.container.getElementsByClassName("dplayer-bar-wrap")[0].offsetWidth, this.options.video.thumbnails, this.events), this.on("loadedmetadata", function () {
        ...
        e.exports = function (e) {
            ...
            return e.video && !e.video.type && (e.video.type = "auto"), e.danmaku && !e.danmaku.user && (e.danmaku.user = "DIYgod"), e.subtitle && (!e.subtitle.type && (e.subtitle.type = "webvtt"), !e.subtitle.fontSize && (e.subtitle.fontSize = "20px"), !e.subtitle.bottom && (e.subtitle.bottom = "40px"), !e.subtitle.color && (e.subtitle.color = "#fff")), e.video.quality && (e.video.url = [e.video.quality[e.video.defaultQuality].url]), e.lang && (e.lang = e.lang.toLowerCase()), e.icons && (e.icons = Object.assign({}, t.icons, e.icons)), e.contextmenu = e.contextmenu.concat([{
                text: "About author",
        ...
        var i = {
            ...
            contextmenuList: function (e, t) {
                for (var n = '<div class="dplayer-menu">', i = 0; i < e.length; i++) n += '<div class="dplayer-menu-item"><a target="_blank" href="' + e[i].link + '">' + t(e[i].text) + "</a></div>";
                return n += "</div>"
            },
        ...
        var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            o = function () {
                ...
                return s(e, [{
                    ...
                    value: function (e, t) {
                        for (var n = this, i = [], a = 0, s = 0; s < e.length; ++s) this.options.apiBackend.read(e[s], function (s) {
                            return function (o, l) {
                    ...
                    value: function (e) {
                        ...
                        for (var c = document.createDocumentFragment(), u = 0; u < e.length; u++) ! function (a) {
                            ...
                            switch (e[a].type) {
                                case "right":
                                    l = d(s, e[a].type, o), l >= 0 && (s.style.width = o + 1 + "px", s.style.top = n * l + "px", s.style.transform = "translateX(-" + i + "px)");
                                    break;
                                case "top":
                                    l = d(s, e[a].type), l >= 0 && (s.style.top = n * l + "px");
                                    break;
                                case "bottom":
                                    l = d(s, e[a].type), l >= 0 && (s.style.bottom = n * l + "px");
                                    break;
                                default:
                                    console.error("Can't handled danmaku type: " + e[a].type)
                            }
                            l >= 0 && (s.classList.add("dplayer-danmaku-move"), c.appendChild(s))
                        }(u);
